...
def build_parser() -> argparse.ArgumentParser:
    ...
    demo_economic.add_argument("--external-transfer-cents", type=int, default=500)
    demo_economic.add_argument("--retained-operating-cents", type=int, default=2000)
    ...
    demo_economic_live.add_argument("--external-transfer-cents", type=int, default=500)
    demo_economic_live.add_argument("--retained-operating-cents", type=int, default=2000)
